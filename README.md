...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-va3frje.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-va3frje.containers.anotherwebservice.com/
...
```
git clone git@github.com:joeltejeda/container-va3frje.git
cd container-va3frje
```
...
```
docker attach container-va3frje
```
